...
const DetailStream = (props: Props) => {
  ...
  console.log("☠️ ~ DetailStream ~ params:", params);
  const mockData = {
    timestamp: "1729241184",
    depositAmount: "100",
    startTime: "1729241184",
    endTime: 1729505660,
  };

  const [streamedPercent, setStreamedPercent] = useState(30);
  const [withDrawnPercent, setWithDrawnPercent] = useState(30);
    ...
    <div className="relative flex size-full justify-center">
      ...
      <div className="flex h-full w-[532px] flex-col py-8 pl-8">
        ...
        <div className="mb-8 mt-4 flex items-center gap-4">
          <button className="button-primary size-[42px] rounded-full bg-[#2A2E41] p-0 text-core-gray">
        ...
        <div className="flex w-full flex-col items-center rounded-lg bg-[#242838] p-6">
          <div className="flex w-full justify-between">
            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center space-x-2">
                <Checkbox
                  className="flex justify-center border-2 border-core-border bg-[#1e212f] data-[state=checked]:bg-[#266cd9]"
                />
                <label
                  htmlFor="terms"
              ...
              <button className="flex items-center justify-center gap-2 text-[11pt] font-bold text-core-gray">
                <CopyIcon />
                <p>Share Link</p>
              </button>
            </div>
          ...
          <div className="flex w-full items-center gap-2">
            <button className="button-primary w-full flex-1 gap-2 bg-[#2a2e41] font-bold">
              ...
              />
              <p>{truncateString("0x832jfhiuh32jhkf8932hkhhfds987f3", 6, 3)}</p>
            </button>
